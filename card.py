...
bounds_lines = [Line(-(width-height*1j)*px_to_cm/2, -(width+height*1j)*px_to_cm/2),
...
for element in tiling.elements:
    ...
    new_points = [margins*point+(1-margins)*center_point
                  for point in points]
...
border_coords = [-x_min, y_min, x_min, y_min, x_min, y_max, -x_min, y_max, -x_min, y_min]
y_inner_min = y_min+margins/2
x_inner_min = x_min-margins/2
y_inner_max = y_max-margins/2
inner_border_coords = [-x_inner_min, y_inner_min, x_inner_min, y_inner_min, x_inner_min,
                       y_inner_max, -x_inner_min, y_inner_max, -x_inner_min, y_inner_min]
